...
+989151234749 & www.linkedin.com/in/masoud-masoumi-moghadam/\\
...
\item[] Master of Science in
        ...
        \item \textbf{Selected Coursework}: Artificial Neural Network (19/20) - Machine Learning (19.5/20) - Evolutionary Algorithms (19/20) - Pattern Recognition (14/20) - Game Theory (15/20) - Data Mining (16/20) - Advanced Computer Network (15/20) - Digital Image Processing (17/20) - Advanced Operational System (19/20) - E-Commerce (16/20)
        \item Advisers:
...
\item[] Bachelor of Science in
        ...
        \item GPA: 3.8/5.0
        %\&
        %\href{http://ee.sharif.edu/~aref/}
         %          {Prof. Mohammad Reza Aref}
          %         \\
        \end{innerlist}
\end{outerlist}
...
% Machine Learning - Deep Learning - Compiler - Data Pre-processing - Numerical Linear Algebra %Econometrics: Methods and Applications - Public Economics - Personal Finance - Financial Markets - Introduction to Corporate Finance - Financial Engineering and Risk Management - Social and Economic Networks: Models and Analysis %-
%Market Analytics
...
C/C++, Python, R, PHP, MySQL, MATLAB\\
%Java,
%Assembly(8085, 8051)\\
%\halfblankline
%\item \textbf{Applications}: MATLAB, Simulink, Octave, R, Excel\\
%Codevision, Quartus, Pspice\\
...
\begin{loneinnerlist}
%\item \textbf{Programming}:
\textbf{PyTorch, Tensorflow, Keras, OpenCV, Caffe, MXnet, Gensim, NLTK}
...
\begin{loneinnerlist}
\item \textbf{Machine Learning ● Computer Vision Expert}— \href{https://www.linkedin.com/company/partdp-ai/about/}{\textbf{PartAI Reserch Center, Mahshhad, Iran}} Aug 2019 -- Present
...
\begin{itemize}
   ...
   \item[--] Real-time Pedestrian/Vehicle tracking and Re-Identification services like Deep-Sort.
    \item[--] Deployed face recognition on embedded devices for a catering service automation .
    \item[--] Illegal construction detection service on aerial (GIS) images using attention mechanism on CNN.
    \item[--] Violence detection and spotting using 3d-CNN namely as "RWF-2000 flow-gated network" .
    \item[--] Face similarity estimation using one-shot learning approach with Siamese networks.
    \item[--] Forgery detection and spotting using error level analysis and luminance gradient features.

\end{itemize}

\item \textbf{Machine Learning ● Computer Vision Expert}— \href{https://www.natix.io}{\textbf{NATIX Edge vision, Hamburg, Germany}} Aug 2020 -- Dec 2020
...
\begin{itemize}
    ...
    \item[--] Quantization and Deployment were further implemented on production to speed up the inference performance.
...
\begin{itemize}
    \item[--] In this project, I contributed to a pedestrian detection and tracking on live rtsp camera.
...
\item
\href{http://uut.ac.ir/content/1969/Siamak-Sarmady}
                   {Dr. \textbf{Siamak Sarmady}} (siamak.sarmady@gmail.com)
\item
